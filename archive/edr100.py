        ...
        callbacks=[
            ...
            PeriodicTrigger(
                InferenceRunner(
                    ...
                    [
                        ScalarStats("total_loss"),
                        ClassificationError("re_accu", "re_accuracy"),
                    ],
                ),
                every_k_epochs=1,
            ),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-coe", dest="coe", default=0.5, type=float, help="value for loss addition"
    )
    parser.add_argument(
    ...
    argdict = vars(args)
    name = "mdb{}_seed_{}_rnn_dim_{}_pre_epochs_{}_epochs_{}".format(
        MAX_LEN,
        argdict["seed"],
        argdict["rnn_dim"],
        argdict["pre_epochs"],
    ...
    if args.command == "pretrain":
        ...
        if args.previous_model:
            ...
            load_path = "./train_log/edr{}:{}/model-{}".format(
                MAX_LEN, name, args.previous_model
            )
        ...
        if args.best_model:
            ...
            best_model_path = os.path.join(
                "./train_log/edr{}:{}/".format(MAX_LEN, name),
                "model-" + str(args.best_model),
            )
            ...
            pickle.dump(
                ...
                open("./train_log/edr{}:{}/p_r.pkl".format(MAX_LEN, name), "wb"),
            )
            with open(
                "./train_log/edr{}:{}/{}.txt".format(MAX_LEN, name, "best_model"),
                "w",
                encoding="utf-8",
            ) as f:
                f.write(
            ...
            with open(
                "./train_log/edr{}:{}/{}.txt".format(MAX_LEN, name, name),
                "w",
                encoding="utf-8",
            ) as f:
                f.write(name + "\n")
