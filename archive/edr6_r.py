...
if __name__ == "__main__":
    ...
    if args.command == "pretrain":
        ...
        if args.previous_model:
            ...
            load_path = "./train_log/edr6_r:{}/model-{}".format(
        ...
        if args.best_model:
            ...
            best_model_path = os.path.join(
                "./train_log/edr6_r:{}/".format(name), "model-" + str(args.best_model)
            )
            ...
            with open(
                "./train_log/edr6_r:{}/{}.txt".format(name, "best_model"),
                "w",
                encoding="utf-8",
            ) as f:
                f.write(
            ...
            with open(
                "./train_log/edr6_r:{}/{}.txt".format(name, name), "w", encoding="utf-8"
            ) as f:
                for model in [
                    ...
                    for data in ["pn1_r", "pn2_r", "pn3_r"]:
                        ...
                        p100, p200, p300 = evaluate(
                            Model(args),
                            os.path.join(
                                "./train_log/edr6_r:{}/".format(name), "model-" + model
                            ),
                            data_path,
                            args.batch_size,
                        )
