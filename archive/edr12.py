...
if __name__ == "__main__":
    ...
    if args.command == "pretrain":
        ...
        if args.previous_model:
            ...
            load_path = "./train_log/edr12:{}/model-{}".format(
        ...
        if args.best_model:
            ...
            best_model_path = os.path.join(
                "./train_log/edr12:{}/".format(name), "model-" + str(args.best_model)
            )
            ...
            with open(
                "./train_log/edr12:{}/{}.txt".format(name, "best_model"),
                "w",
                encoding="utf-8",
            ) as f:
                f.write(
            ...
            with open(
                "./train_log/edr12:{}/{}.txt".format(name, name), "w", encoding="utf-8"
            ) as f:
                f.write(name + "\t")
                for model in [
                    ...
                    for data in ["pn1", "pn2", "pn3"]:
                        ...
                        p100, p200, p300 = evaluate(
                            Model(args),
                            os.path.join(
                                "./train_log/edr12:{}/".format(name), "model-" + model
                            ),
                            data_path,
                            BATCH_SIZE,
                        )
