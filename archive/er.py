    ...
    def __iter__(self):
        ...
        for _ in range(self.__len__()):
            ...
            if not self.isTrain:
                ...
                dropout = 0.8
                rec_dropout = 0.8
            yield [Xs,Pos1s,Pos2s,HeadPoss,TailPoss,X_len,max_seq_len,total_sents,total_bags,SentNum,ReLabels,\
                    HeadLabels,TailLabels,rec_dropout,dropout]
...
class Model(ModelDesc):
    ...
    def build_graph(self, input_x, input_pos1, input_pos2, head_pos, tail_pos,  x_len, seq_len, total_sents,\
                    total_bags, sent_num, input_y,head_label, tail_label, rec_dropout, dropout):
...
def predict(model,model_path,data_path):
    ...
    pred_config=PredictConfig(
        ...
        input_names=['input_x', 'input_pos1', 'input_pos2', 'head_pos', 'tail_pos', 'x_len', 'seq_len', 'total_sents',\
                    'total_bags', 'sent_num', 'input_y', 'head_label', 'tail_label', 'rec_dropout', 'dropout'],
...
if __name__=='__main__':
    ...
    if args.command=='train':
        ...
        with open('pn.txt','w',encoding='utf-8')as f:
            ...
            for model in ['160300','146560','151140','155720','160300','164880','169460','174040','178620','183200']:
                f.write(model+'\t')
