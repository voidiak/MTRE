...
if __name__ == "__main__":
    ...
    argdict = vars(args)
    name = "l2_{}_rnn_dim_{}_gcn_dim_{}_proj_dim_{}_dep_proj_dim_{}_coe_{}_lr_{}".format(
        argdict["l2"],
        argdict["rnn_dim"],
        argdict["gcn_dim"],
        argdict["proj_dim"],
    ...
    if args.command == "DP":
        ...
        if args.previous_model:
            ...
            load_path = "./train_log/edr15:{}/model-{}".format(
        ...
        if args.best_model:
            ...
            best_model_path = os.path.join(
                "./train_log/edr15:{}/".format(name), "model-" + str(args.best_model)
            )
            ...
            with open(
                "./train_log/edr15:{}/{}.txt".format(name, "best_model"),
                "w",
                encoding="utf-8",
            ) as f:
                f.write(
            ...
            with open(
                "./train_log/edr15:{}/{}.txt".format(name, name), "w", encoding="utf-8"
            ) as f:
                f.write(name + "\t")
                for model in [str(step * (2 + 1) + i * step) for i in range(8)]:
                    ...
                    for data in ["pn1", "pn2", "pn3"]:
                        ...
                        p100, p200, p300 = evaluate(
                            Model(args),
                            os.path.join(
                                "./train_log/edr15:{}/".format(name), "model-" + model
                            ),
                            data_path,
                            BATCH_SIZE,
                        )
