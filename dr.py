...
if __name__ == '__main__':
    ...
    if args.command == 'pretrain':
        ...
        if args.best_model:
            ...
            best_model_path = os.path.join('./train_log/dr:{}/'.format(name), 'model-' + str(args.best_model))
            ...
            pickle.dump({'precision': p_, 'recall': r_}, open('./train_log/dr:{}/dr_p_r.pkl'.format(name), 'wb'))
            with open('./train_log/dr:{}/{}.txt'.format(name, 'dr_best_model'), 'w', encoding='utf-8')as f:
                f.write('precision:\t{}\nrecall:\t{}\nf1:\t{}\nauc:\t{}\n'.format(p, r, f1, aur))
                f.write(name + '\n')
